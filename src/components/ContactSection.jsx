        ...
        <div className="grid lg:grid-cols-2 gap-8 bg-gray-50 rounded-2xl shadow-lg p-6 lg:p-10 border-2 border-blue-500">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <button className="flex items-center justify-center gap-2 px-4 py-2 rounded-full font-medium transition-colors duration-200 text-black hover:text-blue-600 border border-gray-400 w-full sm:w-auto">
                <p>Send Message</p>
                <div className="px-3 py-2 rounded-full bg-blue-500">
          ...
          <div className="bg-gray-100 rounded-[25px] p-6">
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-6">
              {boxData.map((box, idx) => (
                <div key={idx} className="flex flex-col items-start">
                  ...
                  />
                  <h3 className="text-2xl sm:text-4xl font-bold mb-1">
                    {box.title}
                  </h3>
            ...
            <div className="flex justify-center items-center gap-4 sm:gap-8 flex-wrap">
              {visibleLogos.map((logo, idx) => (
                <div
                  key={idx}
                  className="flex justify-center items-center bg-white rounded-full p-3 sm:p-4 shadow-lg w-16 h-16 sm:w-20 sm:h-20"
                >
                  <img
                    src={logo}
                    alt={`slider logo ${idx}`}

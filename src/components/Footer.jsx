        ...
        <div>
            ...
            <div className="flex gap-5">
                {[
                    ...
                    <div
                        key={i}
                        className="bg-[#1A2238] rounded-full p-2 flex items-center justify-center sm:w-12 sm:h-12 w-9 h-9"
                    >
                        <img
                            src={imgSrc}
                            alt={`Review ${i + 1}`}
    ...
    return (
        <>
            <footer className="bg-[#0A0F1F] text-gray-300 pt-15">
                            ...
                            {[
                                ...
                                >
                                    <img
                                        ...
                                        className="sm:w-12 sm:h-12 w-9 h-9 object-cover rounded shadow"
                                    />
                ...
                {/* Bottom bar */}
                <div className="mt-15 flex justify-center mb-0 px-2">
                    <div className="bg-blue-600 w-full sm:w-[90%] max-w-full rounded-t-2xl px-4 py-4 flex flex-col sm:flex-row justify-between items-center gap-4 text-[12px] text-white flex-wrap">
                        <p className="text-center sm:text-left">© 2025 InvoZone. All Rights Reserved.</p>
